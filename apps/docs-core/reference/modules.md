...
[packages/core/src/utils.ts:14](https://github.com/executablebooks/thebe/blob/280bb7d/packages/core/src/utils.ts#L14)
...
▸ **makeServer**(`config`): [`ThebeServer`](classes/ThebeServer.md)
